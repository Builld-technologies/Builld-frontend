      ...
      <div className="max-w-7xl w-full px-6 md:px-10 mx-auto relative z-10 flex flex-col justify-center">
        ...
        >
          ...
          <motion.p className="text-lg max-w-2xl" variants={fadeUpVariant}>
            We&apos;re your tech partner, turning ideas into fully functional
            digital experiences. With our streamlined process, we deliver
            exceptional results in weeks, not months.
          </motion.p>
        </motion.div>
      </div>
    </section>
